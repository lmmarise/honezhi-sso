...
public class OauthClient {
	...
	@Column(name = "ranking", nullable = false, columnDefinition = "smallint comment '排序，默认值100，值越小越靠前(rank是保留字)'")
	private short ranking;

	@Column(name = "remark", length = 255, nullable = true, columnDefinition = "varchar(255) comment '备注'")
	private String remark;

	@Column(name = "state_enum", length = 255,nullable = false, columnDefinition = "smallint comment '是否启动, 1正常，2禁用'")
	private short stateEnum;

	@Column(name = "delete_enum",nullable = false, columnDefinition = "smallint comment '是否删除, 1正常，2删除'")
